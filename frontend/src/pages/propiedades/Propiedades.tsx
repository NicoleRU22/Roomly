        ...
        {wizardStep === 1 && (
          <form onSubmit={handleStep1Submit} className="max-w-xl mx-auto bg-white border border-slate-200 p-8 rounded-3xl space-y-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-500 mb-1.5">Dirección</label>
                <input
                  type="text"
                  placeholder="ej: Av. Larco 453, Miraflores, Lima, Perú"
                  value={address}
                  onChange={(e) => setAddress(e.target.value)}
                  className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-slate-900 focus:outline-none focus:border-purple-655 transition-colors"
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-500 mb-1.5">Baños</label>
                  <input
                    type="number"
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-2.5 py-2.5 bg-white border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:border-purple-650 transition-colors"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-2.5 py-2.5 bg-white border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:border-purple-650"
                      >
        ...
        {wizardStep === 3 && (
          <div className="max-w-2xl mx-auto space-y-6">
            <div className="pb-1 border-b border-slate-200/60">
              ...
              <p className="text-xs text-slate-500 mt-1">Verifica todos los detalles antes de crear tu propiedad</p>
            </div>
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-3xl space-y-5 shadow-sm">
              <div>
                ...
                <p className="text-xs text-slate-505 mt-1.5">
                  {address}
                </p>
              </div>
                  ...
                  {roomsList.map((room, index) => (
                    <div key={index} className="flex justify-between items-center p-3.5 bg-white border border-slate-200 rounded-2xl text-xs">
                      <div>
                        ...
                        <p className="text-[10px] text-slate-450 mt-0.5">Estado: {room.status}</p>
                      </div>
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-[#FAF7FD] border border-purple-100/30 p-3 rounded-2xl">
                    ...
                    <p className="text-[10px] text-slate-505 mt-0.5">{occupiedRoomsCount} ocupados</p>
                  </div>
                  <div className="bg-[#FAF7FD] border border-purple-100/30 p-3 rounded-2xl">
                    ...
                    <p className="text-[10px] text-slate-505 mt-0.5">{inquilinosCount} inquilinos</p>
                  </div>
                  <div className="bg-[#FAF7FD] border border-purple-100/30 p-3 rounded-2xl">
                    ...
                    <p className="text-[10px] text-slate-505 mt-0.5 font-sans">mensual</p>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white border border-slate-200 w-full max-w-md rounded-2xl overflow-hidden shadow-2xl z-10 p-6 space-y-4">
            ...
            <form onSubmit={handleSaveEdit} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-500 mb-1.5">Nombre de la propiedad / Edificio</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-500 mb-1.5">Dirección de la locación</label>
                <input
                  type="text"
