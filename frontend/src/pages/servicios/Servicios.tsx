  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <p className="text-xs text-slate-500">Configura cobros de luz, agua, internet o mantenimientos recurrentes.</p>
        <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white border border-slate-200 w-full max-w-md rounded-2xl overflow-hidden shadow-2xl z-10 p-6 space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-500 mb-1.5">Nombre del Servicio</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-500 mb-1.5">Descripción / Nota</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-500 mb-1.5">Costo Mensual ($)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-500 mb-1.5">Tipo de Servicio</label>
                  <select
                    value={tipo}
              ...
              <div className="border-t border-slate-100 pt-4 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-slate-500 mb-1.5">Alcance</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-500 mb-1.5">Propiedad / Edificio</label>
                    <select
                ...
                {targetType === 'cuarto' && selectedPropertyId && (
                  <div className="mt-3">
                    <label className="block text-xs font-bold text-slate-500 mb-1.5">Seleccionar Habitación</label>
                    <select
